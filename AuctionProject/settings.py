...
SECRET_KEY = 'django-insecure-#7=kq(2$#vif(xzt73)t@^#uz4g7!ngwp48fzkh@$_n$b90hks'
...
MIDDLEWARE = [
    ...
    'authen.middleware.token_auth.TokenAuthenticationMiddleware',
...
# SSE
EVENTSTREAM_ALLOW_NO_GRIP = True
